...
#TODO: add non-default settings
_,path_expr,path_net,L_g_min,L_g_max = sys.argv

#Set the paths for the data
path_expr,path_net ='data/gse30219_lung.csv', 'data/biogrid.human.entrez.tsv'

#Load and process the data
GE,G,labels, rev_labels = data_preprocessing(path_expr, path_net,log2 = False, size = 2000)
